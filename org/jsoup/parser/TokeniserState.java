 ...
 enum TokeniserState
{
  ...
  static final char[] attributeSingleValueCharsSorted = { '\000', '&', '\'' };
  static final char[] attributeDoubleValueCharsSorted = { '\000', '"', '&' };
  static final char[] attributeNameCharsSorted = { '\000', '\t', '\n', '\f', '\r', ' ', '"', '\'', '/', '<', '=', '>' };
  static final char[] attributeValueUnquoted = { '\000', '\t', '\n', '\f', '\r', ' ', '"', '&', '\'', '<', '=', '>', '`' };
