  ...
  static abstract class Tag extends Token { protected String tagName;
    ...
    final void newAttribute() {
      ...
      if (pendingAttributeName != null)
      {
        ...
        if (pendingAttributeName.length() > 0) { String value;
          String value;
          if (hasPendingAttributeValue) {
            value = pendingAttributeValue.length() > 0 ? pendingAttributeValue.toString() : pendingAttributeValueS; } else { String value;
