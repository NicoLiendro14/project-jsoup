...
public abstract interface Connection { public static abstract interface KeyVal { public abstract KeyVal key(String paramString);
    ...
    public abstract KeyVal contentType(String paramString);
  ...
  public static abstract interface Response extends Connection.Base<Response> { public abstract int statusCode();
    ...
    public abstract Response bufferUp();
  ...
  public static abstract interface Request extends Connection.Base<Request> { public abstract java.net.Proxy proxy();
    ...
    public abstract int maxBodySize(); public abstract Request maxBodySize(int paramInt); public abstract boolean followRedirects(); public abstract Request followRedirects(boolean paramBoolean); public abstract boolean ignoreHttpErrors(); public abstract Request ignoreHttpErrors(boolean paramBoolean); public abstract boolean ignoreContentType(); public abstract Request ignoreContentType(boolean paramBoolean); /**
     * @deprecated
     */
    public abstract boolean validateTLSCertificates(); /**
     * @deprecated
     */
    public abstract void validateTLSCertificates(boolean paramBoolean); public abstract javax.net.ssl.SSLSocketFactory sslSocketFactory(); public abstract void sslSocketFactory(javax.net.ssl.SSLSocketFactory paramSSLSocketFactory); public abstract Request data(Connection.KeyVal paramKeyVal); public abstract java.util.Collection<Connection.KeyVal> data(); public abstract Request requestBody(String paramString); public abstract String requestBody(); public abstract Request parser(org.jsoup.parser.Parser paramParser); public abstract org.jsoup.parser.Parser parser(); public abstract Request postDataCharset(String paramString); public abstract String postDataCharset(); } public static abstract interface Base<T extends Base> { public abstract java.net.URL url(); public abstract T url(java.net.URL paramURL); public abstract Connection.Method method(); public abstract T method(Connection.Method paramMethod); public abstract String header(String paramString); public abstract java.util.List<String> headers(String paramString); public abstract T header(String paramString1, String paramString2); public abstract T addHeader(String paramString1, String paramString2); public abstract boolean hasHeader(String paramString); public abstract boolean hasHeaderWithValue(String paramString1, String paramString2); public abstract T removeHeader(String paramString); public abstract Map<String, String> headers(); public abstract Map<String, java.util.List<String>> multiHeaders(); public abstract String cookie(String paramString); public abstract T cookie(String paramString1, String paramString2); public abstract boolean hasCookie(String paramString); public abstract T removeCookie(String paramString); public abstract Map<String, String> cookies(); } public static enum Method { GET(false),  POST(true),  PUT(true),  DELETE(false),  PATCH(true),  HEAD(false),  OPTIONS(false),  TRACE(false);
  ...
  public abstract Connection sslSocketFactory(javax.net.ssl.SSLSocketFactory paramSSLSocketFactory);
  ...
  public abstract Connection data(String paramString1, String paramString2, java.io.InputStream paramInputStream, String paramString3);
